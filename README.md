...
- **Snappier Server (stable)**: CLI binaries `v2.0.0-2` from `https://snappierserver.app/files/`
- **Snappier Server Beta**: CLI binaries `v2.0.0-2` from `https://snappierserver.app/files/`
