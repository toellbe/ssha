...
- **Snappier Server (stable)**: CLI binaries `v2.0.1-1` from `https://snappierserver.app/files/`
- **Snappier Server Beta**: CLI binaries `v2.0.2-4` from `https://snappierserver.app/betaFiles/`
